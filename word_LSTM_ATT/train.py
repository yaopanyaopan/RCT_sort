...
tf.flags.DEFINE_float("margin",10,"...")
...
if chinese_copurs:
    ...
    train, dev, label_train, label_dev, max_word_size, W_embedding = input_helpers.getDataSets_english()
...
with tf.Session() as sess:
        ...
        def dev_step(x1_batch,x2_batch, y_batch, rank_d,doc , rank ,sco):
            ...
            step, loss, scores,score1,score2 =sess.run(
                [global_step, Model.loss, Model.scores,Model.score1,Model.score2], feed_dict)
        ...
        def dev_step1(x1_batch):
            ...
            step,score1,=sess.run(
                [global_step, Model.score1], feed_dict)
