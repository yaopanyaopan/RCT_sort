...
class LSTM_Attention(object):
    ...
    def __init__(self,
        ...
        with tf.name_scope("sentence_out"):
            ...
            self.sentence_output1 ,self.sentence_output1_final = self.Bi_LSTM(self.word_level_output1, self.dropout_keep_prob,self.max_seq_len,hidden_units,name="sentence",input_x=self.input_x1)
            self.sentence_output2 ,self.sentence_output2_final = self.Bi_LSTM(self.word_level_output2, self.dropout_keep_prob,self.max_seq_len,hidden_units,name="sentence",input_x=self.input_x2)
        ...
        with tf.name_scope("full_connect"):
            ...
            with tf.name_scope("score1"):
                ...
                self.score1 = tf.nn.xw_plus_b(self.sentence_output1_final, self.w_all,self.b_all,name='score1')
            with tf.name_scope("score2"):
                self.score2 = tf.nn.xw_plus_b(self.sentence_output2_final, self.w_all, self.b_all, name='score2')
