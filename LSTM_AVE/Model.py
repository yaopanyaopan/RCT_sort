...
class LSTM_Attention(object):
    ...
    def __init__(self,
        ...
        # with tf.variable_scope("sentence_out"):
            ...
            self.sentence_level_output1 = tf.reduce_mean(self.sentence_input1,axis=1,keep_dims=False)
            self.sentence_level_output2 = tf.reduce_mean(self.sentence_input2, axis=1,keep_dims=False)
