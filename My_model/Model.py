...
class LSTM_Attention(object):
    ...
    def __init__(self,
        ...
        # with tf.variable_scope("word_out"):
            ...
            self.word_out2 = self.Bi_LSTM(self.embeded_chars2, self.dropout_keep_prob,self.max_sent_len, self.hidden_units,name="word",input_x=self.input_x2)
        ...
        # with tf.variable_scope("sentence_out"):
            ...
            self.sentence_output1 = self.Bi_LSTM(self.sentence_input1, self.dropout_keep_prob,self.max_seq_len,hidden_units,name="sentence",input_x=self.input_x1)
            self.sentence_output2 = self.Bi_LSTM(self.sentence_input2, self.dropout_keep_prob,self.max_seq_len,hidden_units,name="sentence",input_x=self.input_x2)
            ...
            with tf.variable_scope('dropout'):
                ...
                self.sentence_level_output2 = tf.nn.dropout(
                    self.sentence_level_output2, keep_prob=self.dropout_keep_prob
                )
