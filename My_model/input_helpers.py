...
def NDCG(n_rank,n_sco):
    ...
    for index,rct in enumerate(reli):
        ...
        if num < count:
             ...
             if rct==5.0:
                 count_rct +=1
    print(reli.count(1.0),float(reli.count(1.0))/len(reli))
    print(reli.count(2.0),float(reli.count(2.0))/len(reli))
    print(reli.count(3.0),float(reli.count(3.0))/len(reli))
    print(reli.count(4.0),float(reli.count(4.0))/len(reli))
    print(reli.count(5.0),float(reli.count(5.0))/len(reli))
    print(len(reli))
...
def getDataSets():
    ...
    with open("../data/label_test.pickle","wb") as f4:
        ...
        print(res_labels[:15])
        # print(res_labels.count(1.0))
        # print(res_labels.count(2.0))
        # print(res_labels.count(3.0))
        # print(res_labels.count(4.0))
        # print(res_labels.count(5.0))
