...
class LSTM_Attention(object):
    ...
    def __init__(self,
        ...
        with tf.name_scope("word_out"):
            ...
            self.word_level_output2,num_filters_total2 = self.CNN(self.embeded_chars2, self.embedding_size, self.dropout_keep_prob,self.max_sent_len, name="word")

        with tf.name_scope("full_connect"):
            self.w_all = tf.get_variable(initializer=initializer,shape=[num_filters_total1,1] ,dtype=tf.float32,name="w_all")
            ...
            with tf.name_scope("score2"):
                self.score2 = tf.nn.xw_plus_b(self.word_level_output2, self.w_all, self.b_all, name='score2')
