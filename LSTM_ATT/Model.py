...
class LSTM_Attention(object):
    ...
    def __init__(self,
        ...
        # with tf.variable_scope("sentence_out"):
            ...
            self.sentence_level_output2 ,self.alphas22 = Myattention.attention(self.sentence_input2, self.max_seq_len , self.hidden_units*2, return_alphas=True,name="sentence_level",input_x=self.input_x2)
