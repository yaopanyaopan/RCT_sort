...
pkl_x_raw1 = open('test_W2_sinomed.pickle', 'rb')
x_test = pickle.load(pkl_x_raw1)
pkl_y_test = open('label_test_W2_sinomed.pickle', 'rb')
...
with tf.Session() as sess:
    checkpoint_file = tf.train.get_checkpoint_state('runs/1563719236.6298351')
    ...
    for path in checkpoint_file.all_model_checkpoint_paths:
        ...
        acc = sklearn.metrics.accuracy_score(Label, Pre)
        print(acc)
