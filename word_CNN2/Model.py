...
class LSTM_Attention(object):
    ...
    def __init__(self,
        ...
        with tf.name_scope("full_connect"):
            self.w_all = tf.get_variable(initializer=initializer,shape=[num_filters_total1,2] ,dtype=tf.float32,name="w_all")
            self.b_all = tf.get_variable(initializer=initializer,shape=[2],dtype=tf.float32,name="b_all")
